...
declare const AvatarStyledImage: _stitches_react_types_styled_component.StyledComponent<react.ForwardRefExoticComponent<_radix_ui_react_avatar.AvatarImageProps & react.RefAttributes<HTMLImageElement>>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
interface AvatarProps extends ComponentProps<typeof AvatarStyledImage> {
}
...
declare const TextInputStyled: _stitches_react_types_styled_component.StyledComponent<"input", {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
interface TextInputProps extends ComponentProps<typeof TextInputStyled> {
    prefix?: string;
}
...
declare const CheckboxStyled: _stitches_react_types_styled_component.StyledComponent<react.ForwardRefExoticComponent<_radix_ui_react_checkbox.CheckboxProps & react.RefAttributes<HTMLButtonElement>>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
interface CheckboxProps extends ComponentProps<typeof CheckboxStyled> {
}
